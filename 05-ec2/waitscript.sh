...
aws cloudformation create-stack --stack-name greysongundrum$CURRENT_LAB --template-body "file://$PWD/$CURRENT_LAB.yaml" --capabilities CAPABILITY_IAM CAPABILITY_NAMED_IAM
